...
//static double target_z[N_plane]={0, 50, 909.04, 959.04, 1009.04, 1059.04, 1942.02, 1992.02};
	    ...
	    if (tp->pdgCode==13)
	     {
		  ...
		  if (std::fabs(outvect[0])>100 || std::fabs(outvect[1])>100) cal_stat=0;
