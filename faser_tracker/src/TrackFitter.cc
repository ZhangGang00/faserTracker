...
//
//        shared_ptr<Acts::TrackingGeometry> geo;
//        Acts::Navigator navigator {geo};
//
//        void initializeActs() {
//            geo = make_unique<Acts::Geometry>();
//            navigator = make_unique<Navigator>(geo);
//        }
//
//        vector<TrackCandidate> fitTrack_global(const & TrackCandidate);
//        vector<TrackCandidate> fitTrack_kalman(const & TrackCandidate);
//    }
//
//    void TrackFitter::setStrategy(const string & strategy) {
//
//        if (strategy != "none"   &&
//            strategy != "global" &&
//            strategy != "kalman" &&
...
//
//    vector<FittedTrack> fitTrack_global(const & TrackCandidate) {
//        FittedTrack track;
//        return move(track);
//    }
//
//    vector<FittedTrack> fitTrack_kalman(const & TrackCandidate) {
//        FittedTrack track;
//
//        return move(track);
//    }
