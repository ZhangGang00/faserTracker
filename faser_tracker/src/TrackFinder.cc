...
//
//    struct TrackFinder::impl {
//        vector<TrackCandidate> findTracks_truth();
//        vector<TrackCandidate> findTracks_global();
//        vector<TrackCandidate> findTracks_seed();
//    };
//
//    void setStrategy(const string & strategy) {
//
//        if      (strategy == "none"  ) impl->strategy = impl::NONE;
//        else if (strategy == "global") impl->strategy = impl::GLOBAL;
//        else if (strategy == "kalman") impl->strategy = impl::KALMAN;
//        else if (strategy == "all"   ) impl->strategy = impl::ALL;
//        else {
//            cout << "ERROR  FaserTracker::TrackFitter\n"
//                 << "       Invalid strategy: " << strategy_ << '\n'
//                 << "       Aborting.\n";
//
//            throw runtime_error {"FaserTracker::TrackFitter::setMethod: invalid value"};
//        }
//
//    }
//
//    vector<TrackCandidate> TrackFinder::findTracks() {
//    }
//
////------------------------------------------------------------------------------
//// Implementation details
//
//    vector<TrackCandidate> TrackFinder::impl::findTracks_truth() {
//        return {};
//    }
//
//    vector<TrackCandidate> TrackFinder::impl::findTracks_global() {
//        return {};
//    }
//
//    vector<TrackCandidate> TrackFinder::impl::findTracks_seed() {
//        return {};
//    }
//
//}
